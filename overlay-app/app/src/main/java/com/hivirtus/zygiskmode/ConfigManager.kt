...
data class ModuleConfig(
    ...
    val hideMagisk: Boolean = false,
    val hideKernelSu: Boolean = false,
    val hideApatch: Boolean = false,
    val hideSukisu: Boolean = false,
    val hideAllRootApps: Boolean = false,
    ...
    val mockPhoneSim2: String = "",
    val hookIncomingSms: Boolean = false,
    val hookOutgoingSms: Boolean = false,
    val hookUpiVerification: Boolean = false,
    val hookedUpiApps: Map<String, Boolean> = emptyMap(),
    val autoExtractOtp: Boolean = false,
    val autoForwardToken: Boolean = false,
