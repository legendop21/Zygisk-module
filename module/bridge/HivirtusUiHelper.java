...
public class HivirtusUiHelper {
    ...
    private static final String EMBEDDED_MENU_HTML =
            ...
            + "<div class=card><div class=row><div><h3>Fake Phone Number</h3></div>"
            + "<input type=checkbox id=swF></div><input type=tel id=phone placeholder='+91 XXXXX XXXXX'></div>"
            + "<div class=card><div class=row><div><h3>Incoming Sender ID</h3></div>"
            + "<input type=checkbox id=swS></div><input type=text id=sender placeholder='MYBANK'></div>"
            + "<div class=card><div class=row><div><h3>Intercept & Fake Success</h3><p id=interceptHint class=off>off</p></div>"
            + "<input type=checkbox id=swI checked></div></div>"
            + "<div class=card><div class=row><div><h3>I am Not Root</h3></div>"
            + "<input type=checkbox id=swR></div></div>"
            + "<div class=card><div class=row><div><h3>I Am Not Developer</h3></div>"
            + "<input type=checkbox id=swD></div></div>"
            + "<div class=card><div class=row><div><h3>Telegram</h3></div>"
